    ...
    return (
      <div className="min-h-screen bg-white dark:bg-gray-900">
        ...
        <div className="flex justify-center items-center py-32">
          ...
          <span className="ml-3 text-gray-600 dark:text-gray-300">Chargement des avis...</span>
        </div>
        <Footer />
      </div>
    );
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8">
          ...
          <div className="mb-8 border-b border-gray-200 dark:border-gray-700 pb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Laisser un avis</h2>
            <form onSubmit={handleSubmitReview}>
              <div className="flex items-center gap-2 mb-3">
                <span className="font-medium text-gray-900 dark:text-white">Votre note :</span>
                {[1, 2, 3, 4, 5].map((val) => (
                  <button
                    key={val}
                    type="button"
                    ...
                    className={`text-2xl transition-transform transform hover:scale-125 ${
                      val <= rating ? 'text-yellow-400' : 'text-gray-300 dark:text-gray-500'
                    }`}
                  >
