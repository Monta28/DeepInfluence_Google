  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-8">Conditions G&eacute;n&eacute;rales d&apos;Utilisation</h1>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">3. Inscription et compte utilisateur</h2>
            <div className="text-gray-700 dark:text-gray-300 space-y-3">
              <h3 className="font-bold text-lg text-gray-900 dark:text-white mt-4">3.1. Conditions d'inscription</h3>
              <p>
              ...
              <h3 className="font-bold text-lg text-gray-900 dark:text-white mt-4">3.2. Responsabilité du compte</h3>
              <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">4. Monnaie virtuelle "Coins"</h2>
            <div className="text-gray-700 dark:text-gray-300 space-y-3">
              <h3 className="font-bold text-lg text-gray-900 dark:text-white mt-4">4.1. Fonctionnement</h3>
              <p>
                Les "coins" sont la monnaie virtuelle de la plateforme. 1 coin = 1 euro. Ils servent à payer les consultations et formations.
              </p>

              <h3 className="font-bold text-lg text-gray-900 dark:text-white mt-4">4.2. Achat</h3>
              <p>
              ...
              <h3 className="font-bold text-lg text-gray-900 dark:text-white mt-4">4.3. Non-remboursabilité</h3>
              <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">5. Consultations et réservations</h2>
            <div className="text-gray-700 dark:text-gray-300 space-y-3">
              <h3 className="font-bold text-lg text-gray-900 dark:text-white mt-4">5.1. Réservation</h3>
              <p>
              ...
              <h3 className="font-bold text-lg text-gray-900 dark:text-white mt-4">5.2. Annulation</h3>
              <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <h3 className="font-bold text-lg text-gray-900 dark:text-white mt-4">5.3. Déroulement</h3>
              <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">6. Obligations des utilisateurs</h2>
            <div className="text-gray-700 dark:text-gray-300 space-y-3">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">7. Obligations des experts</h2>
            <div className="text-gray-700 dark:text-gray-300 space-y-3">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">8. Propriété intellectuelle</h2>
            <div className="text-gray-700 dark:text-gray-300 space-y-3">
              <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">9. Responsabilité et garanties</h2>
            <div className="text-gray-700 dark:text-gray-300 space-y-3">
              <h3 className="font-bold text-lg text-gray-900 dark:text-white mt-4">9.1. Rôle d'intermédiaire</h3>
              <p>
              ...
              <h3 className="font-bold text-lg text-gray-900 dark:text-white mt-4">9.2. Disponibilité</h3>
              <p>
              ...
              <h3 className="font-bold text-lg text-gray-900 dark:text-white mt-4">9.3. Limitation de responsabilité</h3>
              <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">10. Suspension et résiliation</h2>
            <div className="text-gray-700 dark:text-gray-300 space-y-3">
              <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">12. Loi applicable et juridiction</h2>
            <div className="text-gray-700 dark:text-gray-300 space-y-3">
              <p>
