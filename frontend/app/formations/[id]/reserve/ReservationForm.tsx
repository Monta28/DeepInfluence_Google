...
export default function ReservationForm({ formationId }: ReservationFormProps) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900"><AppHeader /><div className="max-w-4xl mx-auto p-8 text-gray-600 dark:text-gray-300">Chargement...</div></div>
    );
  }
  if (error || !formation) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900"><AppHeader /><div className="max-w-4xl mx-auto p-8 text-red-500 dark:text-red-400">{error || 'Formation introuvable'}</div></div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <Link href="/formations" className="flex items-center text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 mb-4 cursor-pointer">
            <i className="ri-arrow-left-line mr-2"></i>
            <span>Retour aux formations</span>
          </Link>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Réserver votre place</h1>
          <p className="text-gray-600 dark:text-gray-300">Complétez le formulaire ci-dessous pour réserver votre place à la formation.</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Informations de réservation</h2>
              ...
              <form id="reservation-form" onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-start space-x-3">
                  <input
                    ...
                    className="mt-1"
                  />
                  <label htmlFor="agreeTerms" className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                    J'accepte les{' '}
                ...
                {submitStatus === 'success' && (
                  <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg p-4">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-green-800 dark:text-green-200 font-medium">Réservation confirmée !</p>
                        <p className="text-green-700 dark:text-green-300 text-sm">Vous recevrez un email de confirmation avec tous les détails.</p>
                      </div>
                    </div>
                  </div>
                )}
                ...
                {submitStatus === 'error' && (
                  <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-lg p-4">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-red-800 dark:text-red-200 font-medium">Erreur lors de la réservation</p>
                        <p className="text-red-700 dark:text-red-300 text-sm">{submitError || 'Veuillez réessayer ou contacter le support.'}</p>
                      </div>
                    </div>
                  </div>
                )}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 sticky top-8">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Résumé de la formation</h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white">{formation.title}</h4>
                  <p className="text-gray-600 dark:text-gray-300 text-sm">Par {formation.instructor}</p>
                </div>

                <div className="space-y-2 text-sm">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 dark:text-gray-300">Durée:</span>
                    <span className="font-medium text-gray-900 dark:text-white">{formation.duration}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-600 dark:text-gray-300">Horaires:</span>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium text-gray-900 dark:text-white">{new Date(formation.nextSession).toLocaleDateString('fr-FR')}</span>
                  </div>
                </div>
